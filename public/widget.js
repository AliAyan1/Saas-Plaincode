  ...
  function inject() {
    ...
    form.onsubmit = function (e) {
      ...
      fetch(base + "/api/chat", {
        ...
        .catch(function () {
          var last = messagesDiv.querySelector(".ecom-widget-msg.assistant:last-child");
          if (last) last.textContent = "Sorry, something went wrong. Try again.";
          send.disabled = false;
        });
    };
  }
